...
def nodes(request, node_id=None):
    ...
    """
    #return JsonResponse({"nodes": [{"id": 1, "ip_address": "192.168.2.35", "label": "Asutosh", "ping": True, "channel_id": "1", "uptime": "26:16", "cron": "* * * * * cd /home/user/Documents/asutosh/athenas-owl/ao-shell && touch log_file && echo `date` >> log_file\n0 12 * * 1-5 cd /home/user", "screenshot_url": "/media/screenshots/1_Asutosh_RhKJYyT.jpg"}, {"id": 2, "ip_address": "192.168.2.34", "label": "Rishabh", "ping": True, "channel_id": "2", "uptime": "97:34", "cron": "no crontab for user", "screenshot_url": "/media/screenshots/2_Rishabh_s95DotV.jpg"}, {"id": 3, "ip_address": "192.168.2.234", "label": "TV Recording Beta", "ping": True, "channel_id": "0", "uptime": "16:54", "cron": "no crontab for user", "screenshot_url": "/media/screenshots/3_TV_Recording_Beta_4mqHwkQ.jpg"}]})
    nodes = []
