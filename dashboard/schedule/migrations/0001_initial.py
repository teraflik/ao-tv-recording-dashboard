    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('validity_start',models.DateField(default=datetime.date.today, verbose_name='Validity Start')),
                ('validity_end', models.DateField(default=datetime.date(9999, 12, 31), verbose_name='Validity End')),
            ],
        ),
        migrations.CreateModel(
            name='NodeAllocation',
