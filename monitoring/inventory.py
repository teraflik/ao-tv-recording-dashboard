...
class AnsibleInventoryFile():
    ...
    @property
    def path(self):
        """Get the file path of inventory."""
...
class InventoryManager():
    """
    Provides methods to manage hosts.
    """
    ...
    def ansible_run(self, host, username, password, playbook):
        ...
        Returns 0 if the playbook was successful.
        """
    ...
    def get_file_contents(self, host, username, password, file_path):
        """
        Gets the contents of a file from remote host, given the file path.
        Raises `ConnectionError` if SSH Connection is unsuccessful or if the file does not exist.
        """
